...
(load-theme 'hc-zenburn t) ;; load material theme
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (hc-zenburn-theme helm-lsp dap-mode auto-indent-mode htmlize flycheck-plantuml plantuml-mode company-lsp dash dash-functional epl use-package lsp-ui lsp-sh lsp-javacomp lsp-mode lsp-java window-numbering popwin hungry-delete markdown-mode zenburn-theme better-defaults smex flycheck company))))
(custom-set-faces
